...
const { AVATAR_VOLUNTEER_LOTTIE_PATH } = lottieConstants;
...
<template>
  ...
  >
    <div class="px-5 pb-5">
      ...
      >
        <Icon icon="mingcute:hand-heart-fill" class="inline-block h-[1em]" />
        Volunteer
      </h1>
      <div class="flex flex-wrap justify-between gap-y-8">
        <div class="w-full sm:w-3/4">
          <div class="flex justify-between gap-2 mb-8">
            ...
            >
              <Icon
                icon="fluent-emoji:clapper-board"
          ...
          <p class="text-lg sm:text-xl my-4 ahn-medium">
            ...
            <a
              ...
              >TAAFI (the Toronto Animation Arts Festival International)</a
            >, designing the layout of their 2016 Art Book using Adobe InDesign,
            <Icon icon="logos:adobe-indesign" class="inline-block h-[1em]" />
            creating graphics for the website and promotional materials using
            Adobe Illustrator,
            <Icon icon="logos:adobe-illustrator" class="inline-block h-[1em]" />
            and Adobe Photoshop,
            <Icon icon="logos:adobe-photoshop" class="inline-block h-[1em]" />
            and organizing the Indie Alley portion of the TAAFI Maarket which
            provided a space for independent artists to sell their work.
          </p>
          <ul class="list text-base sm:text-lg my-4 ahn-medium mb-8">
            <li class="list-row">
              ...
              <div>
                Collaborated with a large team of event planners and volunteers
                to organize an art book and independent artist market for a
                non-profit animation festival
              </div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
              ...
              <div>
                Promoted, organized, designed and compiled TAAFI 2016 Art Book
                in Adobe InDesign
              </div>
            </li>
            <li class="list-row">
              ...
              <div>
                Created graphics for the website and promotional materials using
            ...
            <li class="list-row">
              ...
              <div>
                Organized and promoted TAAFI 2016 Indie Alley event and managed
                TAAFI merchandise table
              </div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
              ...
              <div>
                Communicated with artists, exhibitors, guests, sponsors and
                festival attendees to ensure that they had a positive festival
                experience
              </div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
                <Icon icon="fluent-color:document-text-24" />
              </div>
              <div>
                Prepared regular, detailed reports to a Board of Directors to
                keep them informed
              </div>
            </li>
          </ul>
        ...
        <div class="w-full sm:w-1/4">
          <Suspense>
            <LottiePlayer :src="AVATAR_VOLUNTEER_LOTTIE_PATH" autoPlay v-once />
          </Suspense>
        </div>
        ...
        <div class="w-full sm:w-3/4">
          ...
          <ul class="list text-base sm:text-lg my-4 ahn-medium">
            <li class="list-row">
              ...
              <div>
                Assisted blind and visually impaired children with various
