      ...
      <div class="flex flex-wrap justify-between gap-y-8">
        <div class="w-full sm:w-3/4">
          ...
          <p class="text-lg sm:text-xl my-4 ahn-medium">
            I have experience developing content and asynchronously teaching for
            <Icon
              icon="fluent-emoji:man-teacher-light"
          ...
          <ul class="list text-base sm:text-lg my-4 ahn-medium">
            ...
            <li class="list-row">
              ...
              <div>
                Developed course content and recorded instructional videos about
            ...
            <li class="list-row">
              ...
              <div>
                Explained accessibility standards such as WCAG, AODA and ACA and
                topics such as screen readers, text alternatives, semantic
        ...
        <div class="w-full sm:w-1/2">
          ...
          <ul class="list text-base sm:text-lg my-4 ahn-medium">
            <li class="list-row">
              ...
              <div>
                Planned lessons to teach web development in the Web Programming
                and Webmaster programs
              </div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
        ...
        <div class="w-full sm:w-3/4">
          ...
          <p class="text-lg sm:text-xl my-4 ahn-medium">
            I also worked as a Technologist Senior, helping students with course
            content and assignments at Seneca Polytechnic
            <Icon icon="fluent-emoji:school" class="inline-block h-[1em]" />
            in the
            <a
              href="https://web-design-development.senecapolytechnic.ca/"
          ...
          <ul class="list text-base sm:text-lg my-4 ahn-medium">
            ...
            <li class="list-row">
              ...
              <div>
                Explained concepts and broke down class examples into manageable
                chunks
              </div>
            </li>
            <li class="list-row">
