            ...
            <div class="w-full sm:w-3/4">
              ...
              >
                ...
                <li class="list-row">
                  ...
                  <div>
                    Contributed to, updated and debugged software for building
                    3D worlds using JavaScript/TypeScript, Three.js, React Three
                ...
                <li class="list-row">
                  ...
                  <div>
                    ...
                    Meta Quest VR headset and the Meta Quest Developer Hub
                  </div>
                </li>
                <li class="list-row">
                  <div class="text-3xl sm:text-4xl">
                  ...
                  <div>
                    Created AR experiences using 8th Wall, A-Frame, JavaScript
                    and Three.js
                  </div>
                </li>
                <li class="list-row">
