...
const { AVATAR_ILLUSTRATOR_LOTTIE_PATH } = lottieConstants;

const sectionId = "illustrator";
</script>
      ...
      <div class="flex flex-wrap justify-between gap-y-8">
        <div class="w-full sm:w-2/3">
          ...
          <p class="text-lg sm:text-xl my-4 ahn-medium">
            I have been an illustrator and cartoonist since 2009. I have worked
            with traditional mediums such as pencil,
            <Icon icon="fluent-emoji:pencil" class="inline-block h-[1em]" />
            ink, acrylics, watercolour, gouache,
            <Icon icon="fluent-emoji:paintbrush" class="inline-block h-[1em]" />
            cut-paper and clay as well as created digital art with software such
            as Adobe Photoshop,
            <Icon icon="logos:adobe-photoshop" class="inline-block h-[1em]" />
            Adobe Illustrator,
            <Icon icon="logos:adobe-illustrator" class="inline-block h-[1em]" />
            Adobe InDesign,
            ...
            />
            Clip Studio Paint,
            <Icon icon="arcticons:clip-studio" class="inline-block h-[1em]" />
            CorelDRAW,
            <Icon icon="simple-icons:coreldraw" class="inline-block h-[1em]" />
            and more.
          </p>
          <ul class="list text-base sm:text-lg my-4 ahn-medium">
            <li class="list-row">
              ...
              <div>
                ...
                <a
                  href="https://www.tocomix.com/reader/volume_two/toronto-the-rude/1"
                  target="_blank"
                  class="link link-accent link-hover"
                  ><em class="italic">Toronto the Rude</em></a
                >, written by J.M Frey in the comics anthology,
                <em class="italic">Toronto Comics</em>
                Volume 2 using Clip Studio Paint and Adobe Photoshop
              </div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
                <Icon icon="fluent-emoji-flat:artist-palette" />
              </div>
              <div>
                Coloured the story <em class="italic">Home Sweet Home</em>,
                written by Shane Kirshenblatt and Illustrated by Andrew Kwan in
                the
                <a
                ...
                >
                comics anthology using Adobe Photoshop
              </div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
                <Icon icon="fluent-color:chat-24" />
              </div>
              <div>Did lettering for comics in Illustrator</div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
                <Icon icon="fluent-emoji:lemon" />
              </div>
              <div>
                Wrote, penciled, lettered, inked and used Adobe Photoshop to
                colour the online comic strip, Lemon Inc. from 2009 to 2012,
                designed and developed a website for it using HTML, CSS and
                WordPress and compiled the comic strip into a book which I
                designed using Adobe InDesign
              </div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
                <Icon icon="fluent-emoji:open-book" />
              </div>
              <div>
                Wrote, penciled, inked and lettered the autobiographical
                mini-comic,
                <em class="italic">The Book of Tim</em> using Clip Studio Paint
                and traditionally screen printed the cover
              </div>
            </li>
            <li class="list-row">
              <div class="text-3xl sm:text-4xl">
                <Icon icon="material-icon-theme:lottie" />
              </div>
              <div>
                Illustrated the self-portraits of myself which are throughout
                this site using Adobe Illustrator, animated them in Adobe After
                Effects and exported them in JSON format as Lottie animations
              </div>
            </li>
          </ul>
        </div>
